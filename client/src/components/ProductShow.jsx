...
function ProductShow({product}) {
  ...
  return (
    <Link to={"/product/"+product._id}>
        {product.imageUrl ? <img src={`https://backendshopmefy.onrender.com/${product.imageUrl}`} className="product-card-image"/> : <img className="product-card-image" src="https://user-images.githubusercontent.com/24848110/33519396-7e56363c-d79d-11e7-969b-09782f5ccbab.png"/>}
